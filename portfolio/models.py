...
class Project(models.Model):
    ...
    screenshot_1 = models.ImageField(upload_to="portfolio/images/", blank=True)
    screenshot_2 = models.ImageField(upload_to="portfolio/images/", blank=True)
    screenshot_3 = models.ImageField(upload_to="portfolio/images/", blank=True)
